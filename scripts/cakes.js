...
function generateCakeCards() {
  const productContainer = document.querySelector(".cakes-product-list");

  cakeProducts.forEach((product) => {
    const card = document.createElement("div");
    card.classList.add("cakes-product-card");
...
function observeFadingEffect() {
  const productCards = document.querySelectorAll(".cakes-product-card");
